    ...
    <div class="row">
        <div class="col-xs-12">
          <a href="#cdma_new_model" role="button" class=" green btn btn-default" data-toggle="modal">New</a>
            <a href="#cdma_upload_model" role="button" class=" green btn btn-default" data-toggle="modal">上传</a>
        </div>
    </div>
    {{-- CDMA Model start--}}
                     ...
                     <tr>
                        ...
                        <div class="hidden-sm hidden-xs btn-group">
                            <button class="btn btn-xs btn-success">
                                <a href="/cdma/manager/{{$cdma->id}}/edit"><i class="ace-icon fa fa-pencil bigger-120"></i></a>
                            </button>
